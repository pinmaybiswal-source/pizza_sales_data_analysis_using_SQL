-- Creating a Database as pizzahut
create database pizzahut;
use pizzahut;

-- Import data as CSV file
-- Retrieve the all records from an pizzas table.
select * from pizzas;
-- Retrieve the all records from an pizza_types table.
...
-- Retrieve the top 10 records from an Orders table.
...
-- Retrieve the top 10 records from an Order_details table.
